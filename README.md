...
市场上关于饮食类的app比较多，人们对于“吃”也是比较关注的，记录饮食和记录生活一样重要。但市面上的饮食记录软件目标群体更多为减肥群体和养生群体，记录的是饮食的热量及其它元素。

而“饮食日记”主要是一款可以识别果蔬、菜品的产品，主要面向所有年轻群体。它利用图像识别api中的果蔬识别和菜品识别，帮助用户识别果蔬的名称、菜品的名称、卡路里和其他信息，它既可以记录和分享自己的饮食生活，也可以与其他用户进行交流。另外，饮食和情感也是密不可分的，饮食可以影响情感，情感也会反过来影响饮食，运用自然语言处理api-情感倾向分析，分析饮食日记中编写的文案，得出用户的情感倾向，给日记形成一个情感标签，并在连续记录一个星期后，根据分析出的数值，形成一条情感曲线。
